...
3. **Always `smart: true`** - Auto-handles doc size
4. **Search first** - Don't read all docs hoping to find info
5. **Read selectively** - Only fetch what you need
6. **Write concise** - Compact notes, not essays
7. **Don't repeat** - Reference context already loaded
